        ...
        <div className="bg-dark">            
            {tvListings.map(tvListing => {
                ...
                <div className="detailsPage">
                    ...
                    <h2 className="title-name text-light mt-4 ml-4">{tvListing.title}</h2>
                    ...
                    <button className="rent-price text-light bg-primary w-50 h-50">Rent ${tvListing.rentprice}</button>
                    <button className="purchase-price text-light bg-primary w-50 h-50">Buy ${tvListing.purchaseprice}</button>
                    </div>
            })}
